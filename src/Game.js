...
export class Game extends Component {
  ...
  placePiece = (column, row) => {
    let nextPlayer =
      this.state.gameInfo.currentPlayer == this.state.gameInfoplayerOneName
        ? this.state.gameInfo.playerTwoName
        : this.state.gameInfoplayerOneName;
    let updatedMoves = [
      ...this.state.gameInfo.allPlacedMoves,
      (column, row, this.state.gameInfo.currentPlayer),
    ];

    let currentGameStep = this.isGameOver()
      ? GameStep.Complete
      : GameStep.Playing;

    this.setState({
      currentMove: nextPlayer,
      allPlacedMoves: updatedMoves,
